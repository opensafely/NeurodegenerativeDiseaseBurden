...
def get_cms_on_date(date, death_date, return_components=False):
    ...
    for name, codelist, medlist1, medlist2, weight in [
        ...
        ("sclerosis", sclerosis_codelist, None, None, 0.761606), # codelist missing
        ("parkinsonism", parkinsonism_codelist, None, None, 0.546194), #codelist missing
        ("perivascular_leg", perivascular_codelist, None, None, 0.334558), #codelist missing
        ("psychosub_misuse", psychosub_codelist, None, None, 0.449321) #codelist missing
    ]:
